...
if (userNameElement) {
  ...
  // Add animation
  userNameElement.style.animation = 'fadeIn 0.5s ease';
}
...
if (logoutBtn) {
  ...
  logoutBtn.addEventListener('mouseenter', () => {
    ...
    logoutBtn.style.boxShadow = '0 4px 12px rgba(236, 72, 153, 0.4)';
  });

  logoutBtn.addEventListener('mouseleave', () => {
    logoutBtn.style.transform = 'translateY(0)';
    logoutBtn.style.boxShadow = '0 2px 8px rgba(236, 72, 153, 0.3)';
  });
}
