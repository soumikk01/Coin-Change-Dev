...
function CalculatorPage() {
  ...
  const [denomsString, setDenomsString] = useState(
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await fetch(
        'http://localhost:5000/api/calculations/save',
        {
          method: 'POST',
          headers: {
  ...
  const handleApplyDenoms = () => {
    ...
    if (newCoins.length > 0) {
      ...
      alert(
        'Please enter valid denominations (comma-separated positive integers).'
      );
    }
  };
        ...
        <div className="container">
          ...
          <div className="page-header">
            ...
            <p className="header-description">
              Compare Greedy and Dynamic Programming approaches. Use custom
              denominations, view detailed breakdowns, and explore interactive
              charts.
            </p>
          </div>
              ...
              <div className="grid">
                ...
                <div className="card">
                  ...
                  <small className="muted">
                    Enter the amount to make (e.g. 93)
                  </small>
                  ...
                  <div className="footer">
                    Tip: Use the <em>Plot 1–200</em> to visualize how coin
                    counts differ across amounts.
                  </div>
                </div>
                    ...
                    <div className="result-line">
                      ...
                      {greedyResult && dpResult && (
                        <div className="counts">
                          <small className="muted">Greedy:</small>{' '}
                          <b>{greedyResult.used.length}</b>
                          &nbsp; | &nbsp;
                          <small className="muted">DP:</small>{' '}
                          <b>{dpResult.count}</b>
                        </div>
                      )}
                    </div>
            ...
            <div className="explanation-section">
              <div className="card explanation-card">
                ...
                <div className="explanation-content">
                  <h3 className="explanation-heading blue">
                    💡 The Coin Change Problem
                  </h3>
                  <p className="explanation-text">
                    Given a target amount and a set of coin denominations, find
                  ...
                  <p className="explanation-text">
                    <strong>How it works:</strong> Always picks the largest coin
                    that doesn't exceed the remaining amount.
                  </p>
                  <ul className="explanation-list">
                    <li>
                      <strong>Fast:</strong> O(n log n) time
                    </li>
                    <li>
                      <strong>Simple:</strong> Easy to implement
                    </li>
                    <li>
                      <strong>Not Optimal:</strong> Doesn't guarantee minimum
                    </li>
                  </ul>

                  <h3 className="explanation-heading pink">
                    🎯 Dynamic Programming
                  </h3>
                  <p className="explanation-text">
                    <strong>How it works:</strong> Builds solutions from
                    bottom-up to find the true minimum.
                  </p>
                  <ul className="explanation-list">
                    <li>
                      <strong>Optimal:</strong> Guarantees minimum coins
                    </li>
                    <li>
                      <strong>Slower:</strong> O(amount × coins)
                    </li>
                    <li>
                      <strong>Complex:</strong> Uses memorization
                    </li>
                  </ul>

                  <h3 className="explanation-heading purple">
                    ⚖️ When to Use Each
                  </h3>
